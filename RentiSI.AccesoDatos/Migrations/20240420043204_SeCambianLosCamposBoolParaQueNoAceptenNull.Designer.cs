...
namespace RentiSI.AccesoDatos.Migrations
{
    ...
    [Migration("20240420043204_SeCambianLosCamposBoolParaQueNoAceptenNull")]
    partial class SeCambianLosCamposBoolParaQueNoAceptenNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentiSI.Modelos.Impronta", b =>
                {
                    ...
                    b.Property<string>("IdUsuarioResuelveImpronta")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("IdUsuarioResuelveImpronta");
            ...
            modelBuilder.Entity("RentiSI.Modelos.TipoDetalleEstado", b =>
                {
                    b.Property<int>("IdTipoDetalleEstado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTipoDetalleEstado"));

                    b.Property<string>("DescripcionDetalle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("IdTipoDetalleEstado");

                    b.ToTable("TipoDetalleEstado");
                });
            ...
            modelBuilder.Entity("RentiSI.Modelos.Tramite", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaNegocio")
                        .IsRequired()
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("IdUsuarioAsignacion");
            ...
            modelBuilder.Entity("RentiSI.Modelos.TramiteCasuistica", b =>
                {
                    ...
                    b.HasKey("ImprontaId", "CasuisticaId");
            ...
            modelBuilder.Entity("RentiSI.Modelos.Gestion", b =>
                {
                    b.HasOne("RentiSI.Modelos.TipoDetalleEstado", "IdTipoDetalleEstado")
                        .WithMany()
                        .HasForeignKey("IdDetalleEstado");
                    ...
                    b.Navigation("IdTipoDetalleEstado");
            ...
            modelBuilder.Entity("RentiSI.Modelos.Impronta", b =>
                {
                    b.HasOne("RentiSI.Modelos.ApplicationUser", "UsuarioImpronta")
                        .WithMany()
                        .HasForeignKey("IdUsuarioResuelveImpronta");
            ...
            modelBuilder.Entity("RentiSI.Modelos.Tramite", b =>
                {
                    b.HasOne("RentiSI.Modelos.ApplicationUser", "UsuarioAsignacion")
                        .WithMany()
                        .HasForeignKey("IdUsuarioAsignacion");
