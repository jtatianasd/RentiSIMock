...
namespace RentiSI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "El {0} debe tener al menos {2} caracteres y maximo {1} caracteres de longitud .", MinimumLength = 6)]
                ...
                if (result.Succeeded)
                {
                    ...
                    switch (rol)
                    {
                        ...
                        case CNT.Cliente:
                            ...
                            break;
                        case CNT.Coordinador:
                            await _userManager.AddToRoleAsync(user, CNT.Coordinador);
                            break;
                        case CNT.Operativo:
